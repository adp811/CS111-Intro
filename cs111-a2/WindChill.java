...
public class WindChill {
    ...
    public static void main(String[] args) {
        ...
        double T = Double.parseDouble(args[0]); //Input Temperature 
        double v = Double.parseDouble(args[1]); //Input Wind Speed 

        double w = 35.74 + (0.6215*T) + ((0.4275*T) - 35.75) * (Math.pow(v,0.16)); //Compute Wind Chill

        System.out.println(w); //Output Wind Chill
